...
# QR decomposition
The QR decomposition algorithm decomposes a matrix $\mathbf{A}\in\mathbb{R}^{n\times p}$ into the product of two matrices, namely, an orthonormal matrix $\mathbf{Q}\in\mathbb{R}^{n\times n}$ and a trapezoidal matrix \eqn{\mathbf{R}\in\mathbb{R}^{n\times p}}, i.e. $\mathbf{A}=\mathbf{Q}\mathbf{R}$.
